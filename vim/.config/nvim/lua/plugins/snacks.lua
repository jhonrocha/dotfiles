local snacks = {
  {
    ...
    keys = {
      ...
      { "<leader>fB",      function() Snacks.picker.grep_buffers({ hidden = true }) end,                                        desc = "Grep Open Buffers" },
      { "<leader>fw",      function() Snacks.picker.grep({ hidden = true, exclude = { "test" } }) end,                          desc = "Grep" },
